...
export const FACE_SCAN_CAPTURE_STEPS = [
  ...
  },
  {
    ...
    instruction:
      "Turn your head ~30° to your left. Keep shoulders still; only rotate your face.",
  },
  {
    id: "right",
  ...
  },
  {
    ...
    instruction:
      "Natural smile — teeth optional. This helps assess dynamic lines vs static wrinkles.",
  },
] as const;
