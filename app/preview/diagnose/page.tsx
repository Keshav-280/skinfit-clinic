    ...
    <div className="relative min-h-dvh overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-dvh max-w-md flex-col px-4 pb-28 pt-3">
        ...
        <div className="relative mt-6 flex flex-1 flex-col">
          ...
          />
          <Leaf
            className="leaf-drift pointer-events-none absolute right-2 top-8 h-8 w-8 text-[#DF9DA4]/40"
            style={{
          ...
          <span className="relative z-10 mb-4 inline-flex w-fit items-center rounded-full bg-white/75 px-3.5 py-1.5 text-[10px] font-extrabold uppercase tracking-[0.16em] text-[#1E1B31] shadow-sm">
            Recommended
          </span>

          <div className="relative z-10 flex items-center gap-4">
            <div className="relative flex h-[5.25rem] w-[5.25rem] shrink-0 items-center justify-center">
              <div className="absolute inset-0 rounded-full bg-white/50 shadow-[0_0_0_10px_rgba(255,255,255,0.45),0_0_40px_12px_rgba(223,157,164,0.18)]" />
          ...
          <div className="relative z-10 mt-4 flex gap-3">
            ...
            >
              <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#F0EAE2]">
