...
export function GlobalRefreshButton({
  ...
  return (
    <button
      ...
      className={clsx(
        compact
          ? "inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-white/60 bg-white/50 text-[#2C3E6B]/70 backdrop-blur-sm transition-colors hover:bg-white/80 hover:text-[#2C3E6B] sm:h-9 sm:w-9"
