  ...
  return (
    <div className="rounded-xl border border-white/60 bg-white/50 px-3 py-2.5 backdrop-blur-sm">
      <div className="flex items-center justify-between gap-2">
        <p className="text-xs font-semibold text-[#1E1B31]">Zoom</p>
      ...
      <p className="text-[10px] leading-snug text-[#6B7280]">
        <span className="font-semibold tabular-nums text-[#1E1B31]">
      ...
      <div className="mt-1 flex items-center gap-2">
        <button
          ...
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-white/70 bg-white/80 text-[#1E1B31] disabled:opacity-40"
          aria-label="Zoom out"
        >
