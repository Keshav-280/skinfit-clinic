...
export function ScanPhotoGuideDismissCheckbox({ checked, onChange, className = "" }: Props) {
  return (
    <label
      className={`flex cursor-pointer items-start gap-2.5 rounded-xl border border-[#2C3E6B]/15 bg-white/35 px-3.5 py-3.5 text-left text-sm leading-snug text-[#374151] ${className}`}
    >
      <input
        type="checkbox"
        checked={checked}
