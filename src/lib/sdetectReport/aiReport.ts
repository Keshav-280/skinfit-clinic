  ...
  "observations": [
    {
      ...
      "commentary": "2 sentences maximum. Sentence 1: what is actually happening in their skin right now — the mechanism, not just the label, specific to their score. Sentence 2: why this matters for someone of their age and skin type, with Indian context where the data supports it. Do not recommend products or treatments."
    }
  ],
  "insight": "4-6 sentences. This is the most important section — what they read last and remember longest. RULE 1: Connect the dots between the top 3 observations — the root-cause story, why these things happen together. RULE 2: Be age-intelligent (under 28: prevention + strengths; 28-38: early intervention + consistency; 38-48: restoration + protection; 48+: maintain what is strong, address what shifted). RULE 3: Draw on real Indian-specific factors where the data supports it (melanin-rich skin scars/pigments more after inflammation; Bangalore humidity drives year-round sebum; year-round high-UV sun accelerates photoageing; hormonal melasma common in Indian women; refined-carb/dairy/spice diet triggers acne and sebum). RULE 4: End by naming at least one parameter that scored well and what it means for them — a genuine positive, not a platitude. RULE 5: No clinic references, no treatment names, no product categories — pure education and insight only."
}
